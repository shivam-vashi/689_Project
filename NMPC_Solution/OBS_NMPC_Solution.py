...
## edit this file such that ROS based things are removed. OR take the OpEn based part from this code and use it in the project.py code
...
sys.path.insert(1, "/path_to_folder_created_in_step1/optimization-engine/open-codegen/OBS_PANOC_DYNAMIC_MOTOR_MODEL/dynamic_my_optimizer/dynamic_racing_target_point")
...
############################################################################################################################################
#################################### Choose the Track and uncomment corresponding Obstacle Points ##########################################
############################################################################################################################################
"""
WARNING: Update these paths with the name of the folder containing the description of the track,
i.e., where the car will race. Also, select the corresponding obstacles by uncommenting the appropriate lines.
"""
...
### Track 1 - XY coordinates of the obstacles
obs_x = 17.5
obs_y = -6
obs_x_2 = 30
obs_y_2 = -12.5

### Track 2 - XY coordinates of the obstacles
# obs_x = -30
# obs_y = 7
# obs_x_2 = -3
# obs_y_2 = 9

### Track 3 - XY coordinates of the obstacles
# obs_x = -8
# obs_y = 8.5
# obs_x_2 = -11.5
# obs_y_2 = 11
...
circle = patches.Circle((obs_x, obs_y), 1.5, edgecolor='red', facecolor='none')
plt.gca().add_patch(circle)

plt.scatter(obs_x_2, obs_y_2, color='blue', s = 1)
circle = patches.Circle((obs_x_2, obs_y_2), 1.5, edgecolor='red', facecolor='none')
plt.gca().add_patch(circle)
...
plt.scatter(x_positions, y_positions, s=1, c=velocities, cmap='turbo', alpha=1, norm = colors.Normalize(vmin=0, vmax=5))
plt.colorbar(label='Velocity Magnitude')

plt.axis('equal')
fig.savefig("OBS_NMPC_Result.png")